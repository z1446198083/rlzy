    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('ad/ajax_edit');?>">
        <table width="100%" cellspacing="0">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center"><?php echo ($ad_type_arr[$val['type']]); if($val["type"] == 'image'): if(!empty($val['content'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo attach($val["content"],'banner');?>"><img src="/theme/admin/images/filetype/image_s.gif" /></span><?php endif; endif; ?></td>
