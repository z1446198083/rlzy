...
<head>
    ...
    <script href="/theme/admin/js/fontSize.js" ></script>
    <link rel="icon" href="/theme/default/images/bitbug_favicon.ico" type="image/x-icon">
    <link rel="stylesheet" type="text/css" href="/theme/admin/css/font-awesome.min.css"/>
...
<div id="header">
    ...
    <ul class="nav white" id="J_tmenu">
        <!--<li class="top_menu"><a href="javascript:;" data-id="0" hidefocus="true" style="outline:none;"><i class="fa fa-user-o"></i>控制台</a></li>-->
    	<?php if(is_array($top_menus)): $i = 0; $__LIST__ = $top_menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="top_menu"><a href="javascript:;" data-id="<?php echo ($val["id"]); ?>" hidefocus="true" style="outline:none;"><i class="fa <?php echo ($val["classname"]); ?>"></i><?php echo L($val['name']);?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
<div id="content">
