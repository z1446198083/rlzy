...
class ArticleCateModel extends RelationModel {
    ...
    protected $_link = array(
        'article' => array(
            ...
            'class_name' => 'article',
            'foreign_key' => 'cate_id',
            'mapping_fields' => 'id,cate_id,title,img,intro,url',
            'mapping_limit' =>'10',
            'condition' => 'status=1',
            'mapping_order' =>'ordid,add_time desc'
        ),
        'article_index' => array(
            'mapping_type' => self::HAS_MANY,
            'class_name' => 'article',
            'foreign_key' => 'cate_id',
            'mapping_fields' => 'id,cate_id,title,img,intro,url,add_time', 
            'mapping_limit' =>'8', 
            'condition' => 'status=1',
            'mapping_order' =>'ordid,add_time desc'
        ),  
		  'article_index_news' => array(
            'mapping_type' => self::HAS_MANY,
            'class_name' => 'article',
            'foreign_key' => 'cate_id',
            'mapping_fields' => 'id,cate_id,title,img,intro,url,add_time',
